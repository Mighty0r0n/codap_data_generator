...
# Zuerst alle packete Laden um den Namespace für die Funktionen zu haben.
# damit muss man nicht jedes mal package:: vor der Funktion definieren.
# Hier wird ein silent load verwendet um die Console nicht zu überladen
